...
<section class="contents">
	<section class="top d-flex">
		<div class="d-flex border-success p-3">
			<img src="<%= artistInfo.get("photo")%>" width="150">
		</div>
		<div class="ml-3">
			<h4 class="font-weight-bold d-block"><%= artistInfo.get("name")%></h4>
		...
		<table class="table text-center">
			...
			<tbody>
				...
				<tr>
					<td><%=item.get("id")%></td>
					<td><a
						href="/lesson03/quiz02/quiz02.jsp?id=<%=item.get("id")%>"
						class="text-decoration-none"><%=item.get("title")%></a></td>
